                        ...
                        <li>
                            <a href="#">
                                <div>
                                    ...
                                    <div>
                                        @include('core::widgets.progress', array('animated'=> true, 'class'=>'success', 'value'=>'40'))
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    ...
                                    <div>
                                        @include('core::widgets.progress', array('animated'=> true, 'class'=>'info', 'value'=>'20'))
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    ...
                                    <div>
                                        @include('core::widgets.progress', array('animated'=> true, 'class'=>'warning', 'value'=>'60'))
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    ...
                                    <div>
                                        @include('core::widgets.progress', array('animated'=> true,'class'=>'danger', 'value'=>'80'))
